...
import { footerPageLinks,footerNavConfig } from "./config-navigation";
...
export default function Footer() {
  ...
  const mobileList = footerNavConfig.find((i) => i.title === "Pages")?.children || [];

  const desktopList = footerPageLinks.sort(
